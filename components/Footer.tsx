    ...
    <footer className="bg-white border-t border-gray-200 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="mb-4">
              <div className="flex items-center">
                <div className="rounded-full bg-white p-2 shadow-lg border-2 border-black">
                  <Image
                    src="/adora-logo.png"
            ...
            <div className="mb-4 space-y-2">
              <a href="tel:+994707800818" className="flex items-center text-black hover:text-gray-600 transition-colors text-sm">
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-sm text-gray-600">@adora.fashiioon</span>
            </div>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-black mb-4">Sürətli Keçidlər</h3>
          ...
          {/* Legal */}
          <div>
            <h3 className="font-semibold text-black mb-4">Hüquqi</h3>
            <ul className="space-y-2">
              <li>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-400 text-xs">
              Powered by <span className="font-medium">Alvosite</span>
            </p>
          </div>
        </div>
      </div>
