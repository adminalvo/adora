        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Əlaqə Məlumatları</h3>
              <div className="space-y-3 text-gray-600">
                <p>📧 Email: info@adorafashion.az</p>
                <p>📞 Telefon: <a href="tel:+994707800818" className="text-yellow-600 hover:text-yellow-700">+994 70 780 08 18</a></p>
